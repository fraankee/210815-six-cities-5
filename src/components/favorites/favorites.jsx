...
class Favorites extends PureComponent {
  ...
  render() {
    ...
    const cities = [...new Set(offers.map((offer) => offer.address))];
                ...
                {cities.map((city) => (
                  <li key={city} className="favorites__locations-items">
                    ...
                    <div className="favorites__places">
                      {offers.filter(((offer) => offer.address === city)).map((offer) => (
                        <article key={offer.title} className="favorites__card place-card">
